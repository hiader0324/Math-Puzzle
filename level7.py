...
def main7():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 7: Arrange the following unordered numbers in set of first 15 Multiples of 4'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 7 complete... Press Next to start Level 8'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 7 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 7: Arrange the following unordered numbers in set of first 15 Multiples of 4',
...
def getStartingBoard():
    ...
    board = [[4, 20, 36, 52], [8, 24, 40, 56], [12, 28, 44, 60], [16, 32, 48, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 7. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
