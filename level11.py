...
def main11():
    ...
    pygame.display.set_caption('Level 11')
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 11: Arrange the following unordered numbers in set of first 15 Multiples of 8'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 11 complete... Press Next to start Level 12'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 9 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 11: Arrange the following unordered numbers in set of first 15 Multiples of 8',
...
def getStartingBoard():
    ...
    board = [[8, 40, 72, 104], [16, 48, 80, 112], [24, 56, 88, 120], [32, 64, 96, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 11. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
