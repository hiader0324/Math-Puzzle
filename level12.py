...
def main12():
    ...
    pygame.display.set_caption('Level 12')
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 12: Arrange the following unordered numbers in set of first 15 Multiples of 9'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 12 complete...'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 12 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 12: Arrange the following unordered numbers in set of first 15 Multiples of 9',
...
def getStartingBoard():
    ...
    board = [[9, 45, 81, 117], [18, 54, 90, 126], [27, 63, 99, 135], [36, 72, 108, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 12. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
