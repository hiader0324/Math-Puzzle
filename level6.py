...
def main6():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 6: Arrange the following unordered numbers in set of first 15 Multiples of 3'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if counter1 >= 0 and counter2 != 0 and mainBoard == SOLVEDBOARD:
            msg = 'Level 6 complete... Press Next to start Level 7'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 6 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 6: Arrange the following unordered numbers in set of first 15 Multiples of 3',
...
def getStartingBoard():
    ...
    board = [[3, 15, 27, 39], [6, 18, 30, 42], [9, 21, 33, 45], [12, 24, 36, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 6. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
