...
def main5():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 5: Arrange the following unordered numbers in set of first 15 Composite number'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 5 complete... Press Next to start Level 6'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 5 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 5: Arrange the following unordered numbers in set of first 15 Composite number',
...
def getStartingBoard():
    ...
    board = [[4, 10, 16, 22], [6, 12, 18, 24], [8, 14, 20, 25], [9, 15, 21, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 5. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
