...
def main4():
    global text3, text1, text2, font, FPSCLOCK, DISPLAYSURF, BASICFONT, RETRY, RETRY_RECT, NEXT, NEXT_RECT
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 4: Arrange the following unordered numbers in set of first 15 Prime number'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if counter1 >= 0 and counter2 != 0 and mainBoard == SOLVEDBOARD:
            msg = 'Level 4 complete... Press Next to start Level 5'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 4 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 4: Arrange the following unordered numbers in set of first 15 Prime number',
...
def getStartingBoard():
    ...
    board = [[2, 11, 23, 41], [3, 13, 29, 43], [5, 17, 31, 47], [7, 19, 37, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 4. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
