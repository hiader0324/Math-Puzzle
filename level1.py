...
def main1():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 1: Arrange the following unordered numbers in set of first 15 Natural number'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if counter1 >= 0 and counter2 != 0 and mainBoard == SOLVEDBOARD:
            msg = 'Level 1 complete... Press Next to start Level 2'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 1 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 1: Arrange the following unordered numbers in set of first 15 Natural number',
...
def getStartingBoard():
    ...
    board = [[1, 5, 9, 13], [2, 6, 10, 14], [3, 7, 11, 15], [4, 8, 12, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 1. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
