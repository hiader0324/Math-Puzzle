...
def main3():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 3: Arrange the following unordered numbers in set of first 15 Odd number'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if counter1 >= 0 and counter2 != 0 and mainBoard == SOLVEDBOARD:
            msg = 'Level 3 complete... Press Next to start Level 3'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 3 again'
            ...
            if slideTo:
                if mainBoard != SOLVEDBOARD:
                    slideAnimation(mainBoard, slideTo,
                                   'Click tile or press arrow keys to slide. \n Level 3: Arrange the following unordered numbers in set of first 15 Odd number',
...
def getStartingBoard():
    ...
    board = [[1, 9, 17, 25], [3, 11, 19, 27], [5, 13, 21, 29], [7, 15, 23, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 3. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
