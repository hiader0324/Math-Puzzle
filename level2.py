...
def main2():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 2: Arrange the following unordered numbers in set of first 15 Even number'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if counter1 >= 0 and counter2 != 0 and mainBoard == SOLVEDBOARD:
            msg = 'Level 2 complete... Press Next to start Level 3'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 2 again'
            ...
            if slideTo:
                if mainBoard != SOLVEDBOARD:
                    slideAnimation(mainBoard, slideTo,
                                   'Click tile or press arrow keys to slide. \n Level 2: Arrange the following unordered numbers in set of first 15 Even number',
...
def getStartingBoard():
    ...
    board = [[2, 10, 18, 26], [4, 12, 20, 28], [6, 14, 22, 30], [8, 16, 24, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 2. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
