...
def main8():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 8: Arrange the following unordered numbers in set of first 15 Multiples of 5'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 8 complete... Press Next to start Level 9'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
            msg = 'Times Up! Press Try Again to start Level 8 again'
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 8: Arrange the following unordered numbers in set of first 15 Multiples of 5',
...
def getStartingBoard():
    ...
    board = [[5, 25, 45, 65], [10, 30, 50, 70], [15, 35, 55, 75], [20, 40, 60, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 8. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
