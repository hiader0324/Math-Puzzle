...
def main9():
    ...
    while True:  # main game loop
        ...
        msg = 'Click tile or press arrow keys to slide. \n Level 9: Arrange the following unordered numbers in set of first 15 Multiples of 6'  # contains the message to show in the upper left corner.
        counter -= 1
        ...
        if mainBoard == SOLVEDBOARD and counter1 >= 0 and counter2 != 0:
            msg = 'Level 9 complete... Press Next to start Level 10'
            counter1 = int(text1)
            counter = 0
            counter2 = int(text2)
        if mainBoard != SOLVEDBOARD and counter1 == 0 and counter2 == 0:
        ...
        if slideTo:
            if mainBoard != SOLVEDBOARD:
                slideAnimation(mainBoard, slideTo,
                               'Click tile or press arrow keys to slide. \n Level 9: Arrange the following unordered numbers in set of first 15 Multiples of 6',
...
def getStartingBoard():
    ...
    board = [[6, 30, 54, 78], [12, 36, 60, 84], [18, 42, 66, 90], [24, 48, 72, BLANK]]
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Starting Level 9. Please wait...', animationSpeed=int(TILESIZE / 3))
        makeMove(board, move)
